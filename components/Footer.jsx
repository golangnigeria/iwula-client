...
const Footer = () => {
  ...
  const linkSections = [
    ...
    },
    {
      title: "COMPANY",
      links: [
        { text: "About Dr. Iwula", path: "/about" },
    ...
    },
    {
      title: "CONTACT",
      links: [
        { text: "+234-701-470-4943", path: "/", icon: PhoneIcon },
        { text: "info@driwula.com", path: "/", icon: MailIcon },
        {
  ...
  return (
    <footer className="mx-6 bg-white border-t border-slate-200">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
          ...
          <div>
            ...
            <p className="max-w-[410px] mt-6 text-sm">
              👨‍⚕️ Your trusted partner in health education, wellness, and
              personal consultations. Empowering lives through medical insights,
              compassionate care, and expert guidance for a healthier tomorrow.
            </p>
        ...
        <p className="py-4 text-sm text-slate-500 text-center">
          © {new Date().getFullYear()} Dr. Iwula. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
