...
import farmhero from "./farmhero.jpg"
...
export const assets = {
    ...
    product_img7, product_img8, product_img9, product_img10, product_img11, product_img12, farmhero, farmhero1, investnow,
}
...
export const ourSpecsData = [
  {
    ...
    description:
      "Book one-on-one sessions with certified medical professionals across multiple specialties.",
    icon: StethoscopeIcon,
    accent: '#05DF72', // Green for health & trust
  },
  {
    title: "Online Courses & Resources",
    description:
      "Access professional health courses, wellness guides, and medical insights designed for you.",
    icon: BookOpenIcon,
    accent: '#FFAD33', // Orange for learning & energy
  },
  {
    title: "Virtual Appointments",
    description:
      "Join secure video consultations from anywhere and receive personalized medical advice.",
    icon: VideoIcon,
    accent: '#3B82F6', // Blue for technology & reliability
  },
  {
    title: "24/7 Patient Support",
    description:
      "Our support team is available around the clock to answer questions and guide you.",
    icon: HeadsetIcon,
    accent: '#A684FF', // Purple for care & empathy
  },
]
